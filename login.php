...
<html>
	...
	<body>
		<div id="header">
			<!-- <header> -->
			<a href="#" class="logo"><img src="TDT_logo.png" alt="logo" href="#" width="100px" height="50px"></a>
		...
		<div id="content" class="container">
				...
				?>
				<legend>Trang đăng nhập admin</legend>
				<form action="" method="POST">
					...
					<div class="container" style="padding: 16px;">
					    ...
					    <a href="" style=" margin: 10px"> <u>Register</u></a>
					    <a href="" style=" margin: 10px"><u>Quên mật khẩu ?</u></a>
